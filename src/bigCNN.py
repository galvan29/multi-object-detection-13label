...
Original file is located at
    https://colab.research.google.com/drive/1q1lsr5DVfrQ63uqSm_0Q5ZAwxrFY3tIk
"""
...
class Network(nn.Module):
    def __init__(self):
        ...
        # CNN
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=12, stride=2, kernel_size=7, padding = 4)

        self.conv2 = nn.Conv2d(in_channels=12, out_channels= 25, kernel_size=3, padding = 3)

        self.conv3 = nn.Conv2d(in_channels=25, out_channels= 75, kernel_size=3, padding = 2)

        self.conv4 = nn.Conv2d(in_channels=75, out_channels= 210, kernel_size=3, padding = 2)

        self.conv5 = nn.Conv2d(in_channels=210, out_channels= 512, kernel_size=3)
        
        self.conv6 = nn.Conv2d(in_channels=512, out_channels= 512, kernel_size=3)

        self.class_fc1 = nn.Linear(in_features=512, out_features=256)
        self.class_fc2 = nn.Linear(in_features=256, out_features=20)
        self.class_out = nn.Linear(in_features=20, out_features=13)
        
        self.box_fc1 = nn.Linear(in_features=512, out_features=256)
...
#model.load_state_dict(torch.load("models/model_ep499.pth"))
